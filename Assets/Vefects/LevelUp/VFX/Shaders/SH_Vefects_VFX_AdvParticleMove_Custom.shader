...
Shader "Vefects/SH_Vefects_VFX_AdvParticleMove_Custom"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 appendResult376 = (float2(0.0 , ( _Mask_Offset.y + IN.ase_texcoord3.w )));
				float2 texCoord216 = IN.ase_texcoord3.xy * _Mask_Scale + appendResult376;
				...
				float clampResult378 = clamp( ( tex2D( _ColorGradientMask, panner320 ).r * _GradientColor_Multi ) , 0.0 , 1.0 );
				float4 lerpResult285 = lerp( _Color_01 , _Color_02 , clampResult378);
				...
				float3 Color = (( ( ( ( float4( lerpResult353 , 0.0 ) * ( IN.ase_color * float4( (Color329).rgb , 0.0 ) ) ) * temp_output_344_0 ) * temp_output_309_0 ) * _EmissiveIntensity )).rgb;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 panner79 = ( windSpeed200 * _NoiseDistortion_Speed + ( texCoord30 * _NoiseDistortion_Scale ));
				float Distortion64 = ( ( tex2D( _NoiseDistortion_Texture, panner79 ).r * 0.1 ) * _DistortionAmount );
				float2 appendResult376 = (float2(0.0 , ( _Mask_Offset.y + IN.ase_texcoord2.w )));
				float2 texCoord216 = IN.ase_texcoord2.xy * _Mask_Scale + appendResult376;
				float4 tex2DNode214 = tex2D( _Mask_Texture, ( ( Distortion64 * _DistortionMaskIntensity ) + texCoord216 ) );
				float temp_output_227_0 = saturate( ( pow( tex2DNode214.r , _Mask_Power ) * _Mask_Multiply ) );
	...
	CustomEditor "UnityEditor.ShaderGraph.PBRMasterGUISH_Vefects_VFX_AdvParticleMoveT"
	Fallback "Hidden/InternalErrorShader"
	
}
/*ASEBEGIN
Version=18935
0;0;2560;1379;4305.941;3063;1.332581;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;197;-6494.695,-2803.138;Inherit;False;Property;_WindSpeed;Wind Speed;25;0;Create;True;0;0;0;False;0;False;1;-0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;31;-5263.003,-2627.204;Inherit;False;Property;_NoiseDistortion_Scale;NoiseDistortion_Scale;9;0;Create;True;0;0;0;False;0;False;1,1;0.5,1.5;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;32;-4837.001,-2652.375;Inherit;False;Property;_NoiseDistortion_Speed;NoiseDistortion_Speed;13;0;Create;True;0;0;0;False;0;False;0,0;0.2,-0.5;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.SamplerNode;43;-4111.003,-2755.204;Inherit;True;Property;_NoiseDistortion_Texture;NoiseDistortion_Texture;5;0;Create;True;0;0;0;False;0;False;-1;None;7be739fe11d18d7428b2f18c5258c4bd;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;52;-3702.779,-2575.815;Inherit;False;Property;_DistortionAmount;Distortion Amount;20;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;25;-7808,-896;Inherit;False;Property;_Noise_01_Scale;Noise_01_Scale;6;0;Create;True;0;0;0;False;0;False;1,1;1.5,0.5;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.CommentaryNode;313;-4530,206;Inherit;False;2391;470;Flame Mask;11;217;271;216;219;304;227;221;223;222;214;376;;0,0,0,1;0;0
...
Node;AmplifyShaderEditor.Vector2Node;29;-7424,-896;Inherit;False;Property;_Noise_01_Speed;Noise_01_Speed;10;0;Create;True;0;0;0;False;0;False;0,0;0.25,0.4;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.TexCoordVertexDataNode;374;-4573.023,731.6965;Inherit;False;0;4;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;375;-4309.229,665.2398;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;217;-4480,256;Inherit;False;Property;_Mask_Scale;Mask_Scale;11;0;Create;True;0;0;0;False;0;False;1,1;1,1.25;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.DynamicAppendNode;376;-4129.226,579.8643;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SamplerNode;24;-6656,-1024;Inherit;True;Property;_Noise_01_Texture;Noise_01_Texture;2;0;Create;True;0;0;0;False;0;False;-1;None;697582ec7a1d9b64db6045460f56121f;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;242;-6489.086,-783.4067;Inherit;False;Property;_Noises_Power;Noises_Power;19;0;Create;True;0;0;0;False;0;False;1;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;214;-3444.538,224.8561;Inherit;True;Property;_Mask_Texture;Mask_Texture;4;0;Create;True;0;0;0;False;0;False;-1;None;9b6c6d048e4c92f4b980064c31a6b83a;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;222;-3087,470;Inherit;False;Property;_Mask_Power;Mask_Power;18;0;Create;True;0;0;0;False;0;False;1;1.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;221;-2755,458;Inherit;False;Property;_Mask_Multiply;Mask_Multiply;16;0;Create;True;0;0;0;False;0;False;1;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;138;-349.4309,1193.235;Inherit;False;Property;_DepthFade;Depth Fade;23;0;Create;True;0;0;0;False;0;False;0;3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;328;-2851.907,-2886.208;Inherit;False;2641.522;1027.192;COLOR;14;287;317;285;316;283;329;327;318;319;260;320;377;378;379;;0,0,0,1;0;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;377;-1514.212,-2322.249;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;329;-825.4253,-2811.881;Inherit;False;Color;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;240;705.2538,216.8086;Inherit;False;Property;_EmissiveIntensity;Emissive Intensity;24;0;Create;True;0;0;0;False;0;False;1;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;285;-1128.59,-2807.433;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.Vector2Node;316;-2801.907,-2185.482;Inherit;False;Property;_GradientColor_Scale;GradientColor_Scale;8;0;Create;True;0;0;0;False;0;False;1,1;1,1.35;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.ClampOpNode;378;-1346.934,-2325.803;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;283;-1919.328,-2344.922;Inherit;True;Property;_ColorGradientMask;Color Gradient Mask;3;0;Create;True;0;0;0;False;0;False;-1;None;802775e17b37d5a4789ce5206a18826f;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;287;-1512.59,-2807.433;Inherit;False;Property;_Color_01;Color_01;0;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;379;-1845.699,-2091.434;Inherit;False;Property;_GradientColor_Multi;GradientColor_Multi;21;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;260;-1512.59,-2551.433;Inherit;False;Property;_Color_02;Color_02;1;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;375;0;219;2
WireConnection;375;1;374;4
...
ASEEND*/
//CHKSM=A12875654E186CFA103574BF0D3F5285805C37D4