...
Shader "Vefects/SH_Vefects_VFX_AdvParticleMove"
{
	Properties
	{
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[ASEBegin]_Erosion_Texture("Erosion_Texture", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float Distortion64 = ( ( tex2D( _Distortion_Texture, panner79 ).r * 0.1 ) * _Distortion_Amount );
				float2 appendResult369 = (float2(_Mask_Offset.x , ( _Mask_Offset.x + IN.ase_texcoord3.w )));
				float2 texCoord216 = IN.ase_texcoord3.xy * _Mask_Scale + appendResult369;
				...
				float noises205 = saturate( ( pow( tex2D( _Erosion_Texture, ( panner78 + Distortion64 ) ).r , _Erosion_Power ) * _Erosion_Multiply ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 panner79 = ( windSpeed200 * _Distortion_Speed + ( texCoord30 * _Distortion_Scale ));
				float Distortion64 = ( ( tex2D( _Distortion_Texture, panner79 ).r * 0.1 ) * _Distortion_Amount );
				float2 appendResult369 = (float2(_Mask_Offset.x , ( _Mask_Offset.x + IN.ase_texcoord2.w )));
				float2 texCoord216 = IN.ase_texcoord2.xy * _Mask_Scale + appendResult369;
				float4 tex2DNode214 = tex2D( _Mask_Texture, ( ( Distortion64 * _DistortionMaskIntensity ) + texCoord216 ) );
				float temp_output_227_0 = saturate( ( pow( tex2DNode214.r , _Mask_Power ) * _Mask_Multiply ) );
...
/*ASEBEGIN
Version=18921
593;305;2122;1011;-222.5687;278.5728;1.335173;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;197;-6494.695,-2803.138;Inherit;False;Property;_WindSpeed;Wind Speed;24;0;Create;True;0;0;0;False;0;False;1;-0.2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;31;-5263.003,-2627.204;Inherit;False;Property;_Distortion_Scale;Distortion_Scale;9;0;Create;True;0;0;0;False;0;False;1,1;7,0.25;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;32;-4837.001,-2652.375;Inherit;False;Property;_Distortion_Speed;Distortion_Speed;13;0;Create;True;0;0;0;False;0;False;0,0;0.4,-0.75;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.SamplerNode;43;-4111.003,-2755.204;Inherit;True;Property;_Distortion_Texture;Distortion_Texture;5;0;Create;True;0;0;0;False;0;False;-1;None;54d7407d916f82949a377c26763a33ab;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;52;-3702.779,-2575.815;Inherit;False;Property;_Distortion_Amount;Distortion_Amount;20;0;Create;True;0;0;0;False;0;False;0;2.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;25;-7808,-896;Inherit;False;Property;_Erosion_Scale;Erosion_Scale;6;0;Create;True;0;0;0;False;0;False;1,1;10,0.25;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.CommentaryNode;313;-4530,206;Inherit;False;2391;470;Flame Mask;11;217;271;216;219;304;227;221;223;222;214;369;;0,0,0,1;0;0
Node;AmplifyShaderEditor.GetLocalVarNode;203;-7168,-768;Inherit;False;200;windSpeed;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;29;-7424,-896;Inherit;False;Property;_Erosion_Speed;Erosion_Speed;10;0;Create;True;0;0;0;False;0;False;0,0;0.1,-0.5;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;219;-4553,483;Inherit;False;Property;_Mask_Offset;Mask_Offset;12;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.TexCoordVertexDataNode;370;-4562.421,691.1433;Inherit;False;0;4;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;371;-4323.421,648.1433;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;217;-4480,272;Inherit;False;Property;_Mask_Scale;Mask_Scale;11;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.DynamicAppendNode;369;-4212.421,515.1433;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;273;-4430.235,-179.6447;Inherit;False;Property;_DistortionMaskIntensity;Distortion Mask Intensity;21;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;24;-6656,-1024;Inherit;True;Property;_Erosion_Texture;Erosion_Texture;0;0;Create;True;0;0;0;False;0;False;-1;None;4c44ded6d06f02e4a8c9a7435ef898da;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;216;-4109,276;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0.28,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;222;-3087,470;Inherit;False;Property;_Mask_Power;Mask_Power;18;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexCoordVertexDataNode;335;-2146.411,386.8669;Inherit;False;0;4;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.WireNode;366;-3097.198,-108.0415;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;336;-2138.247,586.7021;Inherit;False;Property;_Erosion_Smoothness;Erosion_Smoothness;25;0;Create;True;0;0;0;False;0;False;0;0.8;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SmoothstepOpNode;333;-1761.803,327.976;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;337;-1907.927,540.2372;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;240;705.2538,216.8086;Inherit;False;Property;_EmissiveIntensity;Emissive Intensity;23;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;281;1585.416,330.3898;Inherit;False;280;CameraOffset;1;0;OBJECT;;False;1;FLOAT3;0
...
WireConnection;371;0;219;1
WireConnection;371;1;370;4
WireConnection;78;0;297;0
WireConnection;78;2;29;0
WireConnection;78;1;203;0
WireConnection;369;0;219;1
...
WireConnection;373;2;236;0
WireConnection;373;3;309;0
WireConnection;373;5;281;0
ASEEND*/
//CHKSM=88AC457C9616618B5CB546A1092DB8602BE36256