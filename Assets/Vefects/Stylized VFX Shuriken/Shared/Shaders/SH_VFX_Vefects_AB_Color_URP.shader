	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 Albedo = ( tex2DNode111 * float4( (IN.ase_color).rgb , 0.0 ) * _Boost_Opacity * IN.ase_color.a ).rgb;
				...
				float Occlusion = 1;
				float Alpha = ( tex2DNode111.a * IN.ase_color.a );
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				surfaceDescription.Alpha = ( tex2DNode111.a * IN.ase_color.a );
...
/*ASEBEGIN
Version=18935
7;4;2552;1372;2284.689;533.3527;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;101;1536,0;Inherit;False;Property;_Dst;Dst;5;0;Create;True;0;0;0;True;0;False;10;10;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=F8B3E84F41D99B062005CC61CF166B0EA2855EBB