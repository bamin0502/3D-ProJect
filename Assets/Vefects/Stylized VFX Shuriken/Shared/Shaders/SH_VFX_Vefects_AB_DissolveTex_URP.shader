	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float temp_output_114_0 = ( IN.ase_color.a * saturate( ( (0.0 + (( 1.0 - IN.ase_texcoord3.z ) - 0.0) * (3.0 - 0.0) / (1.0 - 0.0)) + ( tex2DNode106.r + tex2DNode106.g ) ) ) );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( (IN.ase_color).rgb * temp_output_114_0 * IN.ase_texcoord3.w );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 tex2DNode106 = tex2D( _Texture, uv_Texture );
				float temp_output_114_0 = ( IN.ase_color.a * saturate( ( (0.0 + (( 1.0 - IN.ase_texcoord2.z ) - 0.0) * (3.0 - 0.0) / (1.0 - 0.0)) + ( tex2DNode106.r + tex2DNode106.g ) ) ) );
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float4 tex2DNode106 = tex2D( _Texture, uv_Texture );
				float temp_output_114_0 = ( IN.ase_color.a * saturate( ( (0.0 + (( 1.0 - IN.ase_texcoord.z ) - 0.0) * (3.0 - 0.0) / (1.0 - 0.0)) + ( tex2DNode106.r + tex2DNode106.g ) ) ) );
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float4 tex2DNode106 = tex2D( _Texture, uv_Texture );
				float temp_output_114_0 = ( IN.ase_color.a * saturate( ( (0.0 + (( 1.0 - IN.ase_texcoord1.z ) - 0.0) * (3.0 - 0.0) / (1.0 - 0.0)) + ( tex2DNode106.r + tex2DNode106.g ) ) ) );
...
/*ASEBEGIN
Version=18935
7;4;2552;1372;3048.434;667.8854;1.380428;True;False
...
Node;AmplifyShaderEditor.SamplerNode;106;-1520,416;Inherit;True;Property;_Texture;Texture;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;102;1792,0;Inherit;False;Property;_ZWrite;ZWrite;1;0;Create;True;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;119;0,0;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;3;Vefects/SH_VFX_Vefects_AB_DissolveTex_URP;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;True;True;0;True;99;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;True;True;2;5;True;100;10;True;101;1;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;True;2;True;102;True;3;True;103;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;22;Surface;1;638183970242962920;  Blend;0;0;Two Sided;1;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;True;True;False;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=E71F6A146A64387670336AF96BDCE3050D791E5B