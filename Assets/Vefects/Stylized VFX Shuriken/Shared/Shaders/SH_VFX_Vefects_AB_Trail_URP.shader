...
Shader "Vefects/SH_VFX_Vefects_AB_Trail_URP"
{
	Properties
	{
		...
		[ASEBegin]_ZWrite("ZWrite", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 texCoord111 = IN.ase_texcoord3.xy * appendResult110 + ( _TimeParameters.x * appendResult107 );
				float4 tex2DNode112 = tex2D( _Texture, texCoord111 );
				float temp_output_114_0 = ( tex2DNode112.r + tex2DNode112.g );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( ( temp_output_114_0 * _Emissive_Intensity ) * (IN.ase_color).rgb * IN.ase_color.a );
				float Alpha = ( temp_output_114_0 * IN.ase_color.a );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 appendResult110 = (float2(_TrailScale , 1.0));
				float2 appendResult107 = (float2(_TrailSpeed , 0.0));
				float2 texCoord111 = IN.ase_texcoord2.xy * appendResult110 + ( _TimeParameters.x * appendResult107 );
				float4 tex2DNode112 = tex2D( _Texture, texCoord111 );
				float temp_output_114_0 = ( tex2DNode112.r + tex2DNode112.g );
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 appendResult110 = (float2(_TrailScale , 1.0));
				float2 appendResult107 = (float2(_TrailSpeed , 0.0));
				float2 texCoord111 = IN.ase_texcoord.xy * appendResult110 + ( _TimeParameters.x * appendResult107 );
				float4 tex2DNode112 = tex2D( _Texture, texCoord111 );
				float temp_output_114_0 = ( tex2DNode112.r + tex2DNode112.g );
				
				surfaceDescription.Alpha = ( temp_output_114_0 * IN.ase_color.a );
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 appendResult110 = (float2(_TrailScale , 1.0));
				float2 appendResult107 = (float2(_TrailSpeed , 0.0));
				float2 texCoord111 = IN.ase_texcoord1.xy * appendResult110 + ( _TimeParameters.x * appendResult107 );
				float4 tex2DNode112 = tex2D( _Texture, texCoord111 );
				float temp_output_114_0 = ( tex2DNode112.r + tex2DNode112.g );
...
/*ASEBEGIN
Version=18935
7;4;2552;1372;3760.37;795.0845;1.644698;True;False
Node;AmplifyShaderEditor.RangedFloatNode;105;-2912,144;Inherit;False;Property;_TrailSpeed;TrailSpeed;7;0;Create;True;0;0;0;False;0;False;1;0.4;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;108;-2704,-304;Inherit;False;Property;_TrailScale;TrailScale;5;0;Create;True;0;0;0;False;0;False;1;0.05;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;112;-1920,-144;Inherit;True;Property;_Texture;Texture;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.CommentaryNode;104;974,-50;Inherit;False;1238;166;AR;5;99;100;101;102;103;;0,0,0,1;0;0
Node;AmplifyShaderEditor.VertexColorNode;113;-1520,400;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;119;-880,256;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;100;1280,0;Inherit;False;Property;_Src;Src;4;0;Create;True;0;0;0;True;0;False;5;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;102;1792,0;Inherit;False;Property;_ZWrite;ZWrite;0;0;Create;True;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;115;-1424,-48;Inherit;False;Property;_Emissive_Intensity;Emissive_Intensity;3;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;121;0,0;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;3;Vefects/SH_VFX_Vefects_AB_Trail_URP;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;True;True;0;True;99;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;True;True;2;5;True;100;10;True;101;1;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;True;2;True;102;True;3;True;103;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;22;Surface;1;638183970122303304;  Blend;0;0;Two Sided;1;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;True;True;False;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=54C01E2DB8DD89EE2C3F97C560FD3CD2DD7AC03B